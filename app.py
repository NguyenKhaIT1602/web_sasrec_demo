...
DRIVE_FILES = {
    "sasrec_qwen_best.pt": "1GFxHydJ6CSJCiaeJg-zsnoymuNgtJW97",
    "fused_item_emb_128.pt": "1SgNf8X5Dhu_9qGlJjoVg2UyJDUiQW4_V",
    "item_web_meta.pkl": "1gc-FOtOfLlPgJl5sR48lFvrOjTFx2FL8",
    "user_history.pkl": "11z2Qm5wNwRJJ8sQI7YEOPcJRHCzE11KH",
}

MODEL_PATH = os.path.join(APP_DIR, "sasrec_qwen_best.pt")
ITEM_EMB_PATH = os.path.join(APP_DIR, "fused_item_emb_128.pt")
ITEM_META_PATH = os.path.join(APP_DIR, "item_web_meta.pkl")
USER_HISTORY_PATH = os.path.join(APP_DIR, "user_history.pkl")
...
def ensure_required_files():
    ...
    for filename, file_id in DRIVE_FILES.items():
        download_from_google_drive(filename, file_id)
